...
import { IRegister, ILogin, ICreateTourData, IUpdateTourData } from "../../typings/typings"
...
export const updateTour = (updatedTourData: IUpdateTourData, id: ObjectId) => API.patch(`/tour/${id}`, updatedTourData)
